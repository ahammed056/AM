...
namespace TSDAL
{
    ...
    public class SQLHelper
    {
        ...
        public static string GetConnectionString()
        {
            ...
            //return CMDBUtility.ApplicationVariables.ConnectionString;
            //return "Persist Security Info =False;User ID=sa;Password=Pencil@123;Data Source=.;Initial Catalog=KPMgmt;";
            return "Persist Security Info =False;User ID=kpcl;Password=123456;Data Source=172.168.3.88;Initial Catalog=ITMS1;";
        }
        ...
        public static string GetsqlConnectionString()
        {
            ...
            //return CMDBUtility.ApplicationVariables.ConnectionString;
            //return "Persist Security Info =False;User ID=sa;Password=Pencil@123;Data Source=.;Initial Catalog=KPMgmt;";
            //return "server=10.10.9.243;user=hardware;database=ithelpdesk;password=Ahammed@056;convert zero datetime=True;";
            return "server=10.10.9.243;user=hardware;database=prac_ihd;password=Ahammed@056;convert zero datetime=True;";
            
        }

        #region  Get Bool Value
        /// <summary>
        ///  Returns Boolean value from the value
        /// </summary>
        ...
        /// <summary>
        ///  Get corresponding value for the Boolean value
        /// </summary>
        /// <param name="val"></param>
        /// <returns></returns>
