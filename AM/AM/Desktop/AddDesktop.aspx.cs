...
namespace AM.Desktop
{
    public partial class AddCPU : System.Web.UI.Page
    {
        ...
        protected void GridviewBind()
        {
            ...
            MySqlConnection con = new MySqlConnection(ConfigurationManager.ConnectionStrings["mysqlAMS"].ConnectionString.ToString());
         // SqlCommand cmd = new SqlCommand("SELECT * FROM tbl_assets_info" ,acon);
            MySqlCommand cmd = new MySqlCommand("SELECT * FROM tbl_assets_info", con);
        ...
        public bool CheckValidations()
        {
            ...
            else if (txt_ad_Voucher_Number.Text.ToString().Trim().Replace("'", "") == "")
            {
