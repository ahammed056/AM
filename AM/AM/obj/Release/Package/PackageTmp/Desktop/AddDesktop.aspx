                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txt_ad_brand" runat="server" class="form-control" Style="height: 23px; font-size: 12px; padding: 0 0 0 0; margin-top: -10px;"></asp:TextBox>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txt_ad_model" runat="server" class="form-control" Style="height: 23px; font-size: 12px; padding: 0 0 0 0; margin-top: -10px;"></asp:TextBox>
                                            </div>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <asp:TextBox ID="txt_ad_ram_model" runat="server" class="form-control select2" Style="height: 23px; font-size: 12px; padding: 0 0 0 0; margin-top: -10px;"></asp:TextBox>
                                                                        </div>
                                                                   ...
                                                                   <div class="col-md-2">
                                                                       <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label style="height: 25px; font-size: 12px; padding: 0 0 0 0; margin-top: -10px; margin-top: -10px;">
                                                                                Ram Memory</label>
                                                                            <asp:TextBox ID="txt_ad_ram_size" runat="server" class="form-control select2" Style="height: 23px; font-size: 12px; padding: 0 0 0 0; margin-top: -10px;"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:ListBox ID="ListBox1" runat="server" class="form-control select2"></asp:ListBox>
                                                                <asp:GridView ID="GridView1" runat="server" class="form-control select2"></asp:GridView>
                                                            </div>
                                                        </div>
                                                    </div>
