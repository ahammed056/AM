    ...
    <asp:Panel ID="Panel1" runat="server">
        <section class="content">
           ...
           <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <img src="../../dist/img/processor_icon.png" alt="Processor" style="width: 20px; height: 20px; margin-top: -4px;" />&nbsp;&nbsp;<b>Cartridge</b></h3>
                                ...
                                <ContentTemplate>
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <div class="box box-primary">
                                                <div class="box-body">
                                                    <h3 class="box-title">Add Cartridge Model</h3>
                                                    <div class="row" style="padding: 0em 3em 2em 0em;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <asp:TextBox ID="txt_cartridge_amms" runat="server" class="form-control select2"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <asp:Button ID="btn_cartridge_amms" runat="server" Width="56px" Text="Save" class="btn btn-block btn-info btn-sm" OnClick="btn_cartridge_amms_Click" />
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box box-primary">
                                            ...
                                            <asp:GridView ID="gv_cartridges_amms" GridLines="None" runat="server" AutoGenerateColumns="false" Width="100%" Height="175px" PageSize="5" OnPageIndexChanging="gv_processor_asm_PageIndexChanging" AllowPaging="true">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No">
                                                        <ItemTemplate>
                                                            <%# Container.DataItemIndex + 1 %>
                                                    ...
                                                    <asp:TemplateField HeaderText="Model Number">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_brand_model_asm" runat="server" Text='<%#Eval("Catri_Model") %>'></asp:Label>
                                                            <asp:HiddenField ID="hf_brand_model_name" runat="server" Value='<%#Eval("Catri_Model") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>
