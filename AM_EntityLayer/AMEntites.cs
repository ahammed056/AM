...
namespace AM_EntityLayer
{
    ...
    public class CPU_Details
    {
        ...
        private string cpu_am_id2;

        public string Cpu_am_id2
        {
        ...
        private String cpu_model_make; public String Cpu_model_make{ get { return cpu_model_make; } set { cpu_model_make = value; }}
